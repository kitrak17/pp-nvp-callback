...
class PaypalPro
{
    ...
    var $apiUsername = 'sb-2dnzm08038_api1.business.example.com';
    var $apiPassword = 'RZ22B27V4V3R3PKF';
    var $apiSignature = 'ACQf2jZcWynHiFLlJkuIrPl44Gn4A4tuMkZWrfsv2PFk3VXMTp3STdDs';
    var $apiEndpoint = 'https://api-3t.sandbox.paypal.com/nvp'; //https://api-3t.paypal.com/nvp
    var $subject = '';
    var $authToken = '';
    var $authSignature = '';
    var $authTimestamp = '';
    ...
    var $proxyPort = 808;
    var $paypalURL = 'https://www.paypal.com/webscr&cmd=_express-checkout&token=';//'https://www.sandbox.paypal.com/webscr&cmd=_express-checkout&token=';
    var $version = '65.1';
    ...
    */
    ...
    public function paypalCall($params){
        ...
        $nvpstr = "&PAYMENTACTION=".$params['paymentAction']."&AMT=".$params['amt']."&CREDITCARDTYPE=".$params['creditCardType']."&ACCT=".$params['creditCardNumber']."&EXPDATE=".$params['expMonth'].$params['expYear']."&CVV2=".$params['cvv']."&FIRSTNAME=".$params['firstName']."&LASTNAME=".$params['lastName']."&CITY=".$params['city']."&ZIP=".$params['zip']."&COUNTRYCODE=".$params['countryCode']."&CURRENCYCODE=".$params['currencyCode'].$itemStr.$recurringStr;
